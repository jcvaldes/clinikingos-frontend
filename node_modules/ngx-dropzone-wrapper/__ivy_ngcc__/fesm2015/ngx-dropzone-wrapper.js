...
function DropzoneComponent_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyleProp("background-image", ctx_r0.getPlaceholder(), ɵngcc0.ɵɵdefaultStyleSanitizer);
} }
const _c0 = ["*"];
...
DropzoneComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DropzoneComponent, selectors: [["dropzone"]], viewQuery: function DropzoneComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(DropzoneDirective, true);
    } if (rf & 2) {
        var _t;
...
DropzoneComponent = __decorate([ __param(0, Inject(PLATFORM_ID))
], DropzoneComponent);

let DropzoneModule = class DropzoneModule {
};
DropzoneModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: DropzoneModule });
DropzoneModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DropzoneModule_Factory(t) { return new (t || DropzoneModule)(); }, imports: [[CommonModule],
        CommonModule] });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DropzoneComponent, [{
        type: Component,
        args: [{
                selector: 'dropzone',
                exportAs: 'ngxDropzone',
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DropzoneModule, { declarations: function () { return [DropzoneComponent,
        DropzoneDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [CommonModule,
        DropzoneComponent,
        DropzoneDirective]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DropzoneModule, [{
        type: NgModule,
        args: [{
